...
class TestDetectionLogicTranslator(unittest.TestCase):
    ...
    def test_basic_condition_translation(self):
        ...
        condition = self.translator.translate_condition('Image', 'endswith', 'powershell.exe')
        expected = 'Image like ("%powershell.exe")'
        self.assertEqual(condition, expected)

    def test_contains_condition(self):
        """Test contains condition translation"""
        condition = self.translator.translate_condition('CommandLine', 'contains', 'Invoke-Expression')
...
class TestMetadataMapper(unittest.TestCase):
    ...
    def test_tag_filtering(self):
        ...
        many_tags = [
            'attack.execution', 'attack.t1059.001', 'attack.t1059.002', 
            'attack.t1059.003', 'attack.t1059.004', 'attack.t1059.005',
            'attack.persistence', 'attack.defense-evasion',
            'cve.2021-1234', 'cve.2022-5678', 'cve.2023-9012',
            'sysmon', 'detection.emerging_threats'
        ]
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                with open(output_files[0], 'r') as f:
                    ...
                    self.assertEqual(output_data['fields']['name'], 'Test File Conversion')
...
"""
        ...
        tags = fields['tags']
        self.assertTrue(any('_mitreAttackTactic:TA0002' in tag for tag in tags))  # Execution
        self.assertTrue(any('_mitreAttackTechnique:T1059.001' in tag for tag in tags))  # PowerShell
